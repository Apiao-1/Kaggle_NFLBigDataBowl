...
def train_model_list(clf, num=5):
    data = get_train_tree_data()
    ...
    for train_index, test_index in kf.split(X_train, y_train):
        ...
        fscores = pd.Series(clf.feature_importances_, X_train2.columns).sort_values(ascending=False)[:30]
